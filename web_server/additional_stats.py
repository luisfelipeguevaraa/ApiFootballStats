...
results_dict_saved_name = f'2019_2020_2021_{CODE_COUNTRY}_additional_stats_dict.txt'
...
with open(f'../clean_fixtures_and_dataframes/{CODE_COUNTRY}/{results_dict_saved_name}', 'wb') as myFile:
