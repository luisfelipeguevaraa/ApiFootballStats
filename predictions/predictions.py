# -*- coding: utf-8 -*-
"""
Created on Sun Nov 12 13:45:42 2021
...
df_10_saved_name = f'2019_2020_2021_{CODE_COUNTRY}_df_for_ml_10_v2.txt'
...
#print("team_fixture_id_dict_reduced")
#print(team_fixture_id_dict_reduced[33])
...
with open(f'../clean_fixtures_and_dataframes/{CODE_COUNTRY}/{df_10_saved_name}', 'rb') as myFile:
...
#if our newly promoted team has not yet played 10 games we need to fill in this gap
# in order to make a prediction. Lets take the 3 relegated teams, avergae these and use
# that for all newly promoted teams.
...
print(predictions)
predictions.to_csv('pl_predictions_my1.csv', index=False)

with open(f'pl_predictions_{CODE_COUNTRY}.csv', 'wb') as myFile:
    pickle.dump(predictions, myFile)
with open(f'../web_server/pl_predictions_{CODE_COUNTRY}.csv', 'wb') as myFile:
    pickle.dump(predictions, myFile)
